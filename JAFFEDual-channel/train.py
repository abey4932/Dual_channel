...
def main():
    ...
    image_path = "D:/pytorch project/Bishe/JAFFEDual-channel/jaffe_data" #os.path.join(data_root, "Alex", "jaffe_data")  
    ...
    epochs = 500                        ##############################################################################################################################
    save_path = 'D:/pytorch project/Bishe/JAFFEDual-channel/AlexNet.pth'#保存准确率最高的那次模型的路径
    best_acc = 0.0#最佳准确率
    ...
    with open("D:/pytorch project/Bishe/JAFFEDual-channel/train_loss.txt", 'w') as train_los:
        train_los.write(str(train_loss))

    with open("D:/pytorch project/Bishe/JAFFEDual-channel/train_acc.txt", 'w') as train_ac:
