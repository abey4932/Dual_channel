...
def main():
    ...
    image_path = "D:/pytorch project/Bishe/FERplusDual-channel/ferplus" #os.path.join(data_root, "Alex", "jaffe_data")  
    ...
    print("using {} images for training, {} images for validation.".format(train_num,
                                                                           val_num))
    net = AlexNet(num_classes=8, init_weights=True)#num_classes=5花有5种类别，初始化权重
    ...
    epochs = 500                        ##############################################################################################################################
    save_path = 'D:/pytorch project/Bishe/FERplusDual-channel/AlexNet.pth'#保存准确率最高的那次模型的路径
    best_acc = 0.0#最佳准确率
    ...
    print(best_acc)
    with open("D:/pytorch project/Bishe/FERplusDual-channel/train_loss.txt", 'w') as train_los:
        train_los.write(str(train_loss))

    with open("D:/pytorch project/Bishe/FERplusDual-channel/train_acc.txt", 'w') as train_ac:
